...
class SYSPermissionFiltersBase(filters.BaseFilterBackend):
    """
...
class SYSPermissions(permissions.BasePermission):
    """
    ...
    SYSPermissions will call action based methods on the model in the following order:
    ...
    If either of the specific permissions do not exist, the SYSPermissions will
...
class SYSGlobalPermissions(SYSPermissions):
    """
...
class SYSObjectPermissions(SYSPermissions):
    """
...
class SYSPermissionsField(fields.Field):
    """
    ...
    This field will call the same developer defined model methods (hence the SYS) that SYSPermissions
    ...
    def __init__(self, actions=None, additional_actions=None, global_only=False, object_only=False, **kwargs):
        ...
        super(SYSPermissionsField, self).__init__(**kwargs)
    ...
    def bind(self, field_name, parent):
        ...
        assert parent.Meta.model is not None, \
            "SYSPermissions is used on '{}' without a model".format(parent.__class__.__name__)
        ...
        super(SYSPermissionsField, self).bind(field_name, parent)
